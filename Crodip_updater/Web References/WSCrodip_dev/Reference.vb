...
Namespace WSCrodip_dev
    ...
    Partial Public Class CrodipServer
        ...
        Public Sub New()
            MyBase.New
            Me.Url = "http://dev-php5.cognix-systems.com/crodip/www/server"
    ...
    Partial Public Class GetIncrementDiagnosticCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property ResultObject() As Object
            Get
                Me.RaiseExceptionIfNecessary()
        ...
        '''<remarks/>
        Public Overloads ReadOnly Property resultInteger() As Integer
            Get
                Me.RaiseExceptionIfNecessary()
