...
Public Class cr_FicheVerifBanc
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent.cr_FicheVerifBanc.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_numtest() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedcr_FicheVerifBanc
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_FicheVerifBanc = New cr_FicheVerifBanc()
        rpt.Site = Me.Site
        Return rpt
    End Function
