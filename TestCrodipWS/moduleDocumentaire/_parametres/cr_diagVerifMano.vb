...
Public Class cr_diagVerifMano
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent.cr_diagVerifMano.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_diagVerifMano
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_diagVerifMano = New cr_diagVerifMano()
        rpt.Site = Me.Site
        Return rpt
    End Function
