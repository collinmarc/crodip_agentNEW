...
Public Class cr_syntheseBusesxx
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent.cr_syntheseBusesxx.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_syntheseBusesxx
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_syntheseBusesxx = New cr_syntheseBusesxx()
        rpt.Site = Me.Site
        Return rpt
    End Function
