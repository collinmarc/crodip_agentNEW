...
Public Class DiagnosticMano542List
    ...
    Public Property Result() As DiagnosticMano542.ERR542
        ...
        End Set
    End Property
    Public Property diagnosticMano542Array() As DiagnosticMano542()
        Get
    ...
    Public Sub CalcImprecisionNew(pParamCalc542 As ParamDiagCalc542)
        ...
        For Each oMano542 As DiagnosticMano542 In _diagnosticMano542
            oMano542.Erreur = DiagnosticMano542.ERR542.NONCALC
        ...
        'Pour Chaque Mano
        For Each oMano542 As DiagnosticMano542 In _diagnosticMano542
            oMano542.Erreur = DiagnosticMano542.ERR542.OK
        ...
        nNbForte = 0
        For Each oMano542 As DiagnosticMano542 In _diagnosticMano542
            If (oMano542.Erreur = DiagnosticMano542.ERR542.OK) Then
                nNbOk = nNbOk + 1
            End If
            If (oMano542.Erreur = DiagnosticMano542.ERR542.FAIBLE) Then
                nNbFaible = nNbFaible + 1
            End If
            If (oMano542.Erreur = DiagnosticMano542.ERR542.FORTE) Then
                nNbForte = nNbForte + 1
            End If
        Next
        If nNbOk = _diagnosticMano542.Count Then
            'Tout est OK
            Result = DiagnosticMano542.ERR542.OK
            Exit Sub
        End If
        ...
        '    Result = DiagnosticMano542.ERR542.FORTE
        '    Exit Sub
        'End If
        If nNbForte > 0 Then
        ...
        If nNbForte = 0 Then
            Result = DiagnosticMano542.ERR542.FAIBLE
            Exit Sub
        End If
