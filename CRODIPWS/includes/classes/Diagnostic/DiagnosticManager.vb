    ...
    Public Shared Function save(ByVal pDiag As Diagnostic, Optional bsyncro As Boolean = False) As Boolean
        ...
        Try
            ...
            If pDiag.id <> "" Then
                ...
                paramsQuery2 = paramsQuery2 & " , pulverisateurImmatCertificat='" & CSDb.secureString(pDiag.pulverisateurImmatCertificat) & "'"
                paramsQuery2 = paramsQuery2 & " , pulverisateurImmatPlaque='" & CSDb.secureString(pDiag.pulverisateurImmatPlaque) & "'"
