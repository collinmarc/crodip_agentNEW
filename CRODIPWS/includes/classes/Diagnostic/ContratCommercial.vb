...
Public Class ContratCommercial
    ...
    Private _Lignes As List(Of lgContratCommercial)
    Public Property Lignes() As List(Of lgContratCommercial)
        Get
            Return _Lignes
        End Get
        Set(ByVal value As List(Of lgContratCommercial))
            _Lignes = value
        End Set
    End Property
    ...
    Public Sub New()
        Lignes = New List(Of lgContratCommercial)()
    End Sub
