                ...
                If (m_SynchroBoolean.m_bSynchAscBuse) Then
                    ...
                    For Each tmpUpdateBuse As Buse In arrUpdatesBuse
                        Try
                            ...
                            Dim response As Integer = BuseManager.sendWSBuse(m_Agent, tmpUpdateBuse)
                            Select Case response
                                Case -1 ' ERROR
    ...
    Public Sub runascSynchroFVManoEtalon()
        ...
        For Each tmpUpdateFVManometreEtalon As FVManometreEtalon In arrUpdatesFVManometreEtalon
            Try
                ...
                Dim response As Integer = FVManometreEtalonManager.sendWSFVManometreEtalon(m_Agent, tmpUpdateFVManometreEtalon, UpdatedObject)
                Select Case response
                    Case -1 ' ERROR
