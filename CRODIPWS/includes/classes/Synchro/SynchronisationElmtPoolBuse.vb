...
''' </summary>
''' <remarks></remarks>
Public Class SynchronisationElmtPoolBuse
    ...
    Public Overrides Function SynchroDesc(pAgent As Agent) As Boolean
        ...
        Try
            ...
            Catch ex As Exception
                CSDebug.dispError("SynchronisationElmtPoolBuse.SynchroDesc(" & Me.IdentifiantEntier & ") ERR : " & ex.Message.ToString)
                bReturn = False
            End Try

            bReturn = True
        Catch ex As Exception
            CSDebug.dispError("SynchronisationElmtPoolBuse.SynhcroDesc (" & Me.IdentifiantEntier & ")ERR" & ex.Message)
            bReturn = False
        End Try
        Return bReturn
    End Function
    ''' <summary>
    ''' Synhcronisation Ascendante des PoolBuse
    ''' </summary>
