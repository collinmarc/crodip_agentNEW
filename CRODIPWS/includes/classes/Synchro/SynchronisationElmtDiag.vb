    ...
    Public Overrides Function SynchroDesc(pAgent As Agent) As Boolean
        ...
        If (m_SynchroBoolean.m_bSynchDescDiag) Then
            ...
            Try
                ...
                oDiag = DiagnosticManager.getWSDiagnosticById(pAgent, Me.IdentifiantChaine)
        ...
        If (m_SynchroBoolean.m_bSynchDescDiag) Then
            ...
            Try
                ...
                tmpObjectList = DiagnosticBusesManager.getWSDiagnosticBusesByDiagId(pAgent.uid, Me.IdentifiantChaine)
                Dim oCSDB As New CSDb(True)
        ...
        If (m_SynchroBoolean.m_bSynchDescDiag) Then
            ...
            Try
                ...
                tmpObjectList = DiagnosticBusesDetailManager.getWSDiagnosticBusesDetailByDiagId(pAgent.uid, Me.IdentifiantChaine)
                For Each tmpObject In tmpObjectList.Liste
        ...
        If (m_SynchroBoolean.m_bSynchDescDiag) Then
            ...
            Try
                ...
                Dim oCSDB As New CSDb(True)
                tmpObjectList = DiagnosticMano542Manager.getWSDiagnosticMano542ByDiagId(pAgent.uid, Me.IdentifiantChaine)
                For Each tmpObject In tmpObjectList.Liste
        ...
        If (m_SynchroBoolean.m_bSynchDescDiag) Then
            ...
            Try
                ...
                Dim oCSDB As New CSDb(True)
                oListManotroncon833 = DiagnosticTroncons833Manager.getWSDiagnosticTroncons833ByDiagId(pAgent.uid, Me.IdentifiantChaine)
