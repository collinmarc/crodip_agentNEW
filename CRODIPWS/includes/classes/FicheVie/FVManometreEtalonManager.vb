...
#Region "Methodes Web Service"
    ...
    Public Shared Function getWSFVManometreEtalonById(pAgent As Agent, ByVal fvmanometrecontrole_id As String) As Object
        ...
        Try
            ...
            ' Appel au WS
            Dim codeResponse As Integer = objWSCrodip.GetFVManometreEtalon(pAgent.uid, fvmanometrecontrole_id, objWSCrodip_response)
    ...
    Public Shared Function getNewId(ByVal pAgent As Agent) As String
        ...
        If pAgent.idStructure <> 0 Then
            ...
            Try
                ...
                Dim tmpListProfils As DbDataReader = bdd.getResult2s("SELECT id FROM FichevieManometreEtalon WHERE id LIKE '" & pAgent.idStructure & "-" & pAgent.uid & "-%' ORDER BY id DESC")
