...
#End If
    ...
    Public Shared GLOB_ENV_MODESIMPLIFIE As Boolean = (My.Settings.NumVersion = "SIMPLIFIE")
    Public Shared GLOB_ENV_MODEFORMATION As Boolean = (My.Settings.NumVersion = "FORMATION")
