...
Namespace WSCrodip_prod
    ...
    Partial Public Class CrodipServer
        ...
        '''<remarks/>
        Public Function EndGetIdentifiantPulverisateur(ByVal asyncResult As System.IAsyncResult, ByRef IdentifiantPulverisateur As IdentifiantPulverisateur) As Integer
            Dim results() As Object = Me.EndInvoke(asyncResult)
            IdentifiantPulverisateur = CType(results(1),IdentifiantPulverisateur)
            Return CType(results(0),Integer)
        End Function
        ...
        Public Function SendIdentifiantPulverisateur(<System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> ByVal agentId As String, <System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> ByRef IdentifiantPulverisateur As IdentifiantPulverisateur) As <System.Xml.Serialization.XmlElementAttribute("result", Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)> Integer
            Dim results() As Object = Me.Invoke("SendIdentifiantPulverisateur", New Object() {agentId, IdentifiantPulverisateur})
            IdentifiantPulverisateur = CType(results(1),IdentifiantPulverisateur)
            Return CType(results(0),Integer)
        End Function
        
        '''<remarks/>
        Public Function BeginSendIdentifiantPulverisateur(ByVal agentId As String, ByVal IdentifiantPulverisateur As IdentifiantPulverisateur, ByVal callback As System.AsyncCallback, ByVal asyncState As Object) As System.IAsyncResult
            Return Me.BeginInvoke("SendIdentifiantPulverisateur", New Object() {agentId, IdentifiantPulverisateur}, callback, asyncState)
        End Function
        
        '''<remarks/>
        Public Function EndSendIdentifiantPulverisateur(ByVal asyncResult As System.IAsyncResult, ByRef IdentifiantPulverisateur As IdentifiantPulverisateur) As Integer
            Dim results() As Object = Me.EndInvoke(asyncResult)
            IdentifiantPulverisateur = CType(results(1),IdentifiantPulverisateur)
            Return CType(results(0),Integer)
        End Function
        ...
        '''<remarks/>
        Public Overloads Sub SendIdentifiantPulverisateurAsync(ByVal agentId As String, ByVal IdentifiantPulverisateur As IdentifiantPulverisateur)
            Me.SendIdentifiantPulverisateurAsync(agentId, IdentifiantPulverisateur, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub SendIdentifiantPulverisateurAsync(ByVal agentId As String, ByVal IdentifiantPulverisateur As IdentifiantPulverisateur, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("SendIdentifiantPulverisateur", New Object() {agentId, IdentifiantPulverisateur}, Me.SendIdentifiantPulverisateurOperationCompleted, userState)
        End Sub
    ...
    Partial Public Class GetIdentifiantPulverisateurCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property IdentifiantPulverisateur() As IdentifiantPulverisateur
            Get
                Me.RaiseExceptionIfNecessary
                Return CType(Me.results(1),IdentifiantPulverisateur)
            End Get
        End Property
    End Class
