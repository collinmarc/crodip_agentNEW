...
Public Class EtatFVMano
    ...
    Private Function genereDS() As Boolean
        ...
        Try
            ...
            m_ods.Pression.AddPressionRow(Type:=PressionDecroissante, _
                              PointEssai:="1", _
                              PressionMano:=m_oControle.down_pt1_pres_manoCtrl, _
                              PressionManoRef:=m_oControle.down_pt1_pres_manoEtalon, _
                              ErreurAbsolue:=m_oControle.down_pt1_err_abs, _
                              ErreurFond:=m_oControle.down_pt1_err_fondEchelle, _
                              Incertitude:=m_oControle.down_pt1_incertitude, _
                              EMT:=m_oControle.down_pt1_EMT, _
                              Conformité:=m_oControle.down_pt1_conformite)

            m_ods.Pression.AddPressionRow(Type:=PressionDecroissante, _
                                          PointEssai:="2", _
                                          PressionMano:=m_oControle.down_pt2_pres_manoCtrl, _
                                          PressionManoRef:=m_oControle.down_pt2_pres_manoEtalon, _
                                          ErreurAbsolue:=m_oControle.down_pt2_err_abs, _
                                          ErreurFond:=m_oControle.down_pt2_err_fondEchelle, _
                                          Incertitude:=m_oControle.down_pt2_incertitude, _
                                          EMT:=m_oControle.down_pt2_EMT, _
                                          Conformité:=m_oControle.down_pt2_conformite)
            m_ods.Pression.AddPressionRow(Type:=PressionDecroissante, _
                                          PointEssai:="3", _
                                          PressionMano:=m_oControle.down_pt3_pres_manoCtrl, _
                                          PressionManoRef:=m_oControle.down_pt3_pres_manoEtalon, _
                                          ErreurAbsolue:=m_oControle.down_pt3_err_abs, _
                                          ErreurFond:=m_oControle.down_pt3_err_fondEchelle, _
                                          Incertitude:=m_oControle.down_pt3_incertitude, _
                                          EMT:=m_oControle.down_pt3_EMT, _
                                          Conformité:=m_oControle.down_pt3_conformite)
            m_ods.Pression.AddPressionRow(Type:=PressionDecroissante, _
                                          PointEssai:="4", _
                                          PressionMano:=m_oControle.down_pt4_pres_manoCtrl, _
                                          PressionManoRef:=m_oControle.down_pt4_pres_manoEtalon, _
                                          ErreurAbsolue:=m_oControle.down_pt4_err_abs, _
                                          ErreurFond:=m_oControle.down_pt4_err_fondEchelle, _
                                          Incertitude:=m_oControle.down_pt4_incertitude, _
                                          EMT:=m_oControle.down_pt4_EMT, _
                                          Conformité:=m_oControle.down_pt4_conformite)
            m_ods.Pression.AddPressionRow(Type:=PressionDecroissante, _
                                          PointEssai:="5", _
                                          PressionMano:=m_oControle.down_pt5_pres_manoCtrl, _
                                          PressionManoRef:=m_oControle.down_pt5_pres_manoEtalon, _
                                          ErreurAbsolue:=m_oControle.down_pt5_err_abs, _
                                          ErreurFond:=m_oControle.down_pt5_err_fondEchelle, _
                                          Incertitude:=m_oControle.down_pt5_incertitude, _
                                          EMT:=m_oControle.down_pt5_EMT, _
                                          Conformité:=m_oControle.down_pt5_conformite)
            m_ods.Pression.AddPressionRow(Type:=PressionDecroissante, _
                                          PointEssai:="6", _
                                          PressionMano:=m_oControle.down_pt6_pres_manoCtrl, _
                                          PressionManoRef:=m_oControle.down_pt6_pres_manoEtalon, _
                                          ErreurAbsolue:=m_oControle.down_pt6_err_abs, _
                                          ErreurFond:=m_oControle.down_pt6_err_fondEchelle, _
                                          Incertitude:=m_oControle.down_pt6_incertitude, _
                                          EMT:=m_oControle.down_pt6_EMT, _
