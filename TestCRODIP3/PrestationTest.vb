...
'        oCategorie.uidStructure = m_oAgent.uidStructure
'        oCategorie.libelle = "TEST CAT"
'        PrestationCategorieManager.save(oCategorie, m_oAgent)


'        ArrTarif = PrestationTarifManager.getArrayByStructureId(m_oAgent.uidStructure)
'        Dim n As Integer
'        n = ArrTarif.Length
...
'        oTarif.uidStructure = m_oAgent.uidStructure
'        oTarif.tarifHT = 10
'        oTarif.tva = 20
'        oTarif.tarifTTC = 12
...
'        oAgent1.id = 1114
'        oAgent1.uidStructure = oStructure1.id
...
'        oPrestaCategorie1.uidStructure = oStructure1.id
...
'        oPrestaTarif1.uidStructure = oStructure1.id
...
'        oPrestaCategorie2.uidStructure = oStructure2.id
...
'        oPrestaTarif2.uidStructure = oStructure2.id
