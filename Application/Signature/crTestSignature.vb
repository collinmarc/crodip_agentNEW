...
Public Class crTestSignature
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent.crTestSignature.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrTestSignature
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crTestSignature = New crTestSignature()
        rpt.Site = Me.Site
        Return rpt
    End Function
