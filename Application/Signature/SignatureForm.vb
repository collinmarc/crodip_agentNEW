...
Partial Public Class SignatureForm
        ...
        Private Sub addDelegates()
            m_tablet.onGetReportException += New wgssSTU.ITabletEvents2_onGetReportExceptionEventHandler(AddressOf onGetReportException)
            m_tablet.onPenData += New wgssSTU.ITabletEvents2_onPenDataEventHandler(AddressOf onPenData)
            m_tablet.onPenDataEncrypted += New wgssSTU.ITabletEvents2_onPenDataEncryptedEventHandler(AddressOf onPenDataEncrypted)
            m_tablet.onPenDataTimeCountSequence += New wgssSTU.ITabletEvents2_onPenDataTimeCountSequenceEventHandler(AddressOf onPenDataTimeCountSequence)
            m_tablet.onPenDataTimeCountSequenceEncrypted += New wgssSTU.ITabletEvents2_onPenDataTimeCountSequenceEncryptedEventHandler(AddressOf onPenDataTimeCountSequenceEncrypted)
        End Sub
