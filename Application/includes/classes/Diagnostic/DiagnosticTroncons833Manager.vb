...
#Region "Methodes Web Service"
    ...
    ' o
    Public Shared Function getWSDiagnosticTroncons833ById(ByVal diagnosticTroncons833_id As String) As DiagnosticTroncons833List
    ...
    Public Shared Function save(ByVal objDiagnosticTroncons833 As DiagnosticTroncons833, Optional bSynhcro As Boolean = False) As Boolean
        ...
        Try
            ...
            If nEnr = 0 Then
                ...
                If oDR.HasRows() Then
                    oDR.Read()
                    objDiagnosticTroncons833.id = oDR.GetValue(0)
                End If
                oDR.Close()
            Else
