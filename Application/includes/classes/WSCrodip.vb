...
Public Class WSCrodip
    ...
    '    Private Shared m_WS2 As WSCRODIP2.CrodipServer
    ...
    Public Shared Sub Init()
        Try
            ...
            End If
            m_bInit = True
            '           m_WS2 = New WSCRODIP2.CrodipServer
            '          m_WS2.Url = URL
    ...
    '    Public Shared Function getWS2(pUrl As String, Optional pbForce As Boolean = False) As WSCRODIP2.CrodipServer
    '        If (Not m_bInit) Or (pbForce) Then
    '            Init(pUrl)
    '        End If
    '        Return m_WS2
