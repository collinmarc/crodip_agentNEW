...
#Region "Properties"
    ...
    Public Property RacineNumFact() As String
        ...
        Set(ByVal value As String)
            ...
            nElement = FACTURATION_XML_CONFIG.countElements("/root/*")
            If nElement = 7 Then
                FACTURATION_XML_CONFIG.addElement("/root", "racinenumerotation", value)
            Else
    ...
    Public Property DernierNumFact() As String
        ...
        Set(ByVal value As String)
            ...
            nElement = FACTURATION_XML_CONFIG.countElements("/root/*")
            If nElement = 7 Then
                FACTURATION_XML_CONFIG.addElement("/root", "derniernumero", value)
            Else
