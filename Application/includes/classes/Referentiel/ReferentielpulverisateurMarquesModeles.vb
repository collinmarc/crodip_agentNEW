...
<Serializable(), XmlInclude(GetType(ReferentielPulverisateurMarquesModeles))> _
Public Class ReferentielPulverisateurMarquesModeles
    ...
    Public Shared ReadOnly Property NomFichier As String
        Get
            Return Environment.CurrentDirectory & "\config\pulverisateurs\marques-Modeles.xml"
        End Get
    End Property
    ...
    Public Shared Function SynchroDesc(Optional pDateDerniereModif As String = "", Optional pNomFichier As String = "") As RETOURSYNCHRO
        ...
        '    objWSCrodip = WSCrodip.getWS2()

        '    ' Appel au WS
        '    Dim ajour As Integer
        '    Dim pUrl As String
        '    objWSCrodip.GetReferentielPulverisateurMarquesModeles(strDateDernierModif, ajour, pUrl)
        ...
        'Catch ex As Exception
        '    CSDebug.dispFatal("Erreur - ReferentielPulveristaeurMarquesModeles.Synhcrodesc: " & ex.Message)
        '    bReturn = RETOURSYNCHRO.ERREUR
        'End Try
        'Return bReturn
    End Function
