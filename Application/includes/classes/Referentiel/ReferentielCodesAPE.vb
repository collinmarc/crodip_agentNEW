...
<Serializable(), XmlInclude(GetType(ReferentielCodesAPE))> _
Public Class ReferentielCodesAPE
    ...
    Public Shared ReadOnly Property NomFichier As String
        Get
            Return Environment.CurrentDirectory & "\config\codesAPE.xml"
        End Get
    End Property
    ...
    Public Shared Function SynchroDesc(Optional pDateDerniereModif As String = "", Optional pNomFichier As String = "") As RETOURSYNCHRO
        ...
        '    Dim pUrl As String
        '    objWSCrodip.GetReferentielCodesAPE(strDateDernierModif, ajour, pUrl)
        ...
        '    End Select
        'Catch ex As Exception
        '    CSDebug.dispError("Erreur - ReferentielCodesAPE.MajWS: " & ex.Message)
        '    bReturn = RETOURSYNCHRO.ERREUR
        'End Try
        'Return bReturn
    End Function
