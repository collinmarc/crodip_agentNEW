...
#End Region
    ...
    Private Sub controle_bancs_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim arrBusesEtalon As List(Of Buse) = BuseManager.getBusesEtalonByStructureId(agentCourant.idStructure)
        ...
        If controleBanc_numBanc.Text <> "" Then
            ...
            If bTemp Then
                ...
                If nBuse >= 5 Then
                    valider()
                Else
                    MsgBox(CONST_INFO_CTRLBANC_ERR_5BUSES)

                End If

            Else
                MsgBox(CONST_INFO_CTRLBANC_ERR_NOTEMP)
            End If
        Else
            MsgBox(CONST_INFO_CTRLBANC_ERR_NOBANCNUM)
        End If
    End Sub
    Private Sub valider()
        Dim oBuse As Buse
        ...
        If oFV.FVFileName <> "" Then
            CSFile.open(CONST_PATH_EXP & oFV.FVFileName)
        End If
...
#Region " Traitement PDF "

    ' Création du PDF a partir des données du form

#End Region

#Region " Sauvegarde mesures "
    'Private Function getMesuresControle(ByVal curBanc As Banc, ByVal resultat As Boolean, ByVal idFichevie As String, ByVal pagent As Agent) As ControleBanc
    '    Dim oReturn As ControleBanc
    '    Try

    '        Dim oCtrlBanc As ControleBanc = New ControleBanc
    '        Dim oBuse As Buse

    '        oCtrlBanc.idStructure = agentCourant.idStructure
    '        oCtrlBanc.idBanc = curBanc.id
    '        oCtrlBanc.idFichevie = idFichevie
    '        If controleBanc_buse1.SelectedItem IsNot Nothing Then
    '            oBuse = TryCast(controleBanc_buse1.SelectedItem, Buse)
    '            If oBuse IsNot Nothing Then
    '                oCtrlBanc.b1_NumNatBuse = oBuse.idCrodip
    '                oCtrlBanc.b1_pressionEtal = controleBanc_buse1_pressionEtalonnage.Text
    '                oCtrlBanc.b1_debitEtal = controleBanc_buse1_debitEtalonne.Text
    '                oCtrlBanc.b1_3bar_m1 = controleBanc_buse1_3bar_mesure1.Text
    '                oCtrlBanc.b1_3bar_m2 = controleBanc_buse1_3bar_mesure2.Text
    '                oCtrlBanc.b1_3bar_m3 = controleBanc_buse1_3bar_mesure3.Text
    '                oCtrlBanc.b1_3bar_moy = controleBanc_buse1_3bar_moyenne.Text
    '                oCtrlBanc.b1_3bar_ecart = controleBanc_buse1_3bar_ecartAutorise.Text
    '                If controleBanc_buse1_3bar_moyenne.BackColor.Equals(CONST_COLOR_CELL_OK) Then
    '                    oCtrlBanc.b1_3bar_conformite = True
    '                Else
    '                    oCtrlBanc.b1_3bar_conformite = False
    '                End If
    '            End If
    '        End If
    '        If controleBanc_buse2.SelectedItem IsNot Nothing Then
    '            oBuse = TryCast(controleBanc_buse2.SelectedItem, Buse)
    '            If oBuse IsNot Nothing Then
    '                oCtrlBanc.b2_NumNatBuse = oBuse.idCrodip
    '                oCtrlBanc.b2_pressionEtal = controleBanc_buse2_pressionEtalonnage.Text
    '                oCtrlBanc.b2_debitEtal = controleBanc_buse2_debitEtalonne.Text
    '                oCtrlBanc.b2_3bar_m1 = controleBanc_buse2_3bar_mesure1.Text
    '                oCtrlBanc.b2_3bar_m2 = controleBanc_buse2_3bar_mesure2.Text
    '                oCtrlBanc.b2_3bar_m3 = controleBanc_buse2_3bar_mesure3.Text
    '                oCtrlBanc.b2_3bar_moy = controleBanc_buse2_3bar_moyenne.Text
    '                oCtrlBanc.b2_3bar_ecart = controleBanc_buse2_3bar_ecartAutorise.Text
    '                If controleBanc_buse2_3bar_moyenne.BackColor.Equals(CONST_COLOR_CELL_OK) Then
    '                    oCtrlBanc.b2_3bar_conformite = True
    '                Else
    '                    oCtrlBanc.b2_3bar_conformite = False
    '                End If
    '            End If
    '        End If
    '        If controleBanc_buse3.SelectedItem IsNot Nothing Then
    '            oBuse = TryCast(controleBanc_buse3.SelectedItem, Buse)
    '            If oBuse IsNot Nothing Then
    '                oCtrlBanc.b3_NumNatBuse = oBuse.idCrodip
    '                oCtrlBanc.b3_pressionEtal = controleBanc_buse3_pressionEtalonnage.Text
    '                oCtrlBanc.b3_debitEtal = controleBanc_buse3_debitEtalonne.Text
    '                oCtrlBanc.b3_3bar_m1 = controleBanc_buse3_3bar_mesure1.Text
    '                oCtrlBanc.b3_3bar_m2 = controleBanc_buse3_3bar_mesure2.Text
    '                oCtrlBanc.b3_3bar_m3 = controleBanc_buse3_3bar_mesure3.Text
    '                oCtrlBanc.b3_3bar_moy = controleBanc_buse3_3bar_moyenne.Text
    '                oCtrlBanc.b3_3bar_ecart = controleBanc_buse3_3bar_ecartAutorise.Text
    '                If controleBanc_buse3_3bar_moyenne.BackColor.Equals(CONST_COLOR_CELL_OK) Then
    '                    oCtrlBanc.b3_3bar_conformite = True
    '                Else
    '                    oCtrlBanc.b3_3bar_conformite = False
    '                End If
    '            End If
    '        End If
    '        If controleBanc_buse4.SelectedItem IsNot Nothing Then
    '            oBuse = TryCast(controleBanc_buse1.SelectedItem, Buse)
    '            If oBuse IsNot Nothing Then
    '                oCtrlBanc.b4_NumNatBuse = oBuse.idCrodip
    '                oCtrlBanc.b4_pressionEtal = controleBanc_buse4_pressionEtalonnage.Text
    '                oCtrlBanc.b4_debitEtal = controleBanc_buse4_debitEtalonne.Text
    '                oCtrlBanc.b4_3bar_m1 = controleBanc_buse4_3bar_mesure1.Text
    '                oCtrlBanc.b4_3bar_m2 = controleBanc_buse4_3bar_mesure2.Text
    '                oCtrlBanc.b4_3bar_m3 = controleBanc_buse4_3bar_mesure3.Text
    '                oCtrlBanc.b4_3bar_moy = controleBanc_buse4_3bar_moyenne.Text
    '                oCtrlBanc.b4_3bar_ecart = controleBanc_buse4_3bar_ecartAutorise.Text
    '                If controleBanc_buse4_3bar_moyenne.BackColor.Equals(CONST_COLOR_CELL_OK) Then
    '                    oCtrlBanc.b4_3bar_conformite = True
    '                Else
    '                    oCtrlBanc.b4_3bar_conformite = False
    '                End If
    '            End If
    '        End If
    '        If controleBanc_buse5.SelectedItem IsNot Nothing Then
    '            oBuse = TryCast(controleBanc_buse1.SelectedItem, Buse)
    '            If oBuse IsNot Nothing Then
    '                oCtrlBanc.b5_NumNatBuse = oBuse.idCrodip
    '                oCtrlBanc.b5_pressionEtal = controleBanc_buse5_pressionEtalonnage.Text
    '                oCtrlBanc.b5_debitEtal = controleBanc_buse5_debitEtalonne.Text
    '                oCtrlBanc.b5_3bar_m1 = controleBanc_buse5_3bar_mesure1.Text
    '                oCtrlBanc.b5_3bar_m2 = controleBanc_buse5_3bar_mesure2.Text
    '                oCtrlBanc.b5_3bar_m3 = controleBanc_buse5_3bar_mesure3.Text
    '                oCtrlBanc.b5_3bar_moy = controleBanc_buse5_3bar_moyenne.Text
    '                oCtrlBanc.b5_3bar_ecart = controleBanc_buse5_3bar_ecartAutorise.Text
    '                If controleBanc_buse5_3bar_moyenne.BackColor.Equals(CONST_COLOR_CELL_OK) Then
    '                    oCtrlBanc.b5_3bar_conformite = True
    '                Else
    '                    oCtrlBanc.b5_3bar_conformite = False
    '                End If
    '            End If
    '        End If
    '        If controleBanc_buse6.SelectedItem IsNot Nothing Then
    '            oBuse = TryCast(controleBanc_buse1.SelectedItem, Buse)
    '            If oBuse IsNot Nothing Then
    '                oCtrlBanc.b6_NumNatBuse = oBuse.idCrodip
    '                oCtrlBanc.b6_pressionEtal = controleBanc_buse6_pressionEtalonnage.Text
    '                oCtrlBanc.b6_debitEtal = controleBanc_buse6_debitEtalonne.Text
    '                oCtrlBanc.b6_3bar_m1 = controleBanc_buse6_3bar_mesure1.Text
    '                oCtrlBanc.b6_3bar_m2 = controleBanc_buse6_3bar_mesure2.Text
    '                oCtrlBanc.b6_3bar_m3 = controleBanc_buse6_3bar_mesure3.Text
    '                oCtrlBanc.b6_3bar_moy = controleBanc_buse6_3bar_moyenne.Text
    '                oCtrlBanc.b6_3bar_ecart = controleBanc_buse6_3bar_ecartAutorise.Text
    '                If controleBanc_buse6_3bar_moyenne.BackColor.Equals(CONST_COLOR_CELL_OK) Then
    '                    oCtrlBanc.b6_3bar_conformite = True
    '                Else
    '                    oCtrlBanc.b6_3bar_conformite = False
    '                End If
    '            End If
    '        End If
    '        oCtrlBanc.tempExt = controleBanc_extTemp.Text
    '        oCtrlBanc.tempEau = controleBanc_eauTemp.Text
    '        oCtrlBanc.resultat = resultat
    ...
    '        'ControleBancManager.save(oCtrlBanc, pagent)
    '        oReturn = oCtrlBanc
    '    Catch ex As Exception
    '        CSDebug.dispError("frmControleBanc.SaveMesures ERR" + ex.Message)
    '        oReturn = Nothing
    '    End Try
    '    Return oReturn
    'End Function
