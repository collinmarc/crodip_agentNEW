...
#Region " Code généré par le Concepteur Windows Form "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.cbx_manometresEtalon.DisplayMember = "numeroNational"
        ...
        Me.Panel64.Controls.Add(Me.Label5)
        ...
        Me.Label5.Location = New System.Drawing.Point(273, 654)
        Me.Label5.Name = "Label5"
        Me.Label5.Size = New System.Drawing.Size(441, 16)
        Me.Label5.TabIndex = 62
        Me.Label5.Text = "Vous devez être connecté à internet pour valider votre controle"
        '
        'Label46
        '
        ...
        Me.labelInfoEtalon_reference.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.m_bsManoEtalon, "numeroNational", True))
        ...
        Me.labelInfo_reference.DataBindings.Add(New System.Windows.Forms.Binding("Text", Me.m_bsManoControle, "numeroNational", True))
        ...
        Me.tlpEntete.ColumnStyles.Add(New System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 108.0!))
        Me.tlpEntete.Controls.Add(Me.Label6, 4, 0)
        Me.tlpEntete.Controls.Add(Me.Label7, 5, 0)
        Me.tlpEntete.Controls.Add(Me.Label11, 6, 1)
        Me.tlpEntete.Controls.Add(Me.Label10, 5, 1)
        ...
        Me.Label6.Location = New System.Drawing.Point(370, 1)
        Me.Label6.Margin = New System.Windows.Forms.Padding(0)
        Me.Label6.Name = "Label6"
        Me.tlpEntete.SetRowSpan(Me.Label6, 2)
        Me.Label6.Size = New System.Drawing.Size(76, 58)
        Me.Label6.TabIndex = 14
        Me.Label6.Text = "EMT (bar)"
        ...
        Me.Label7.Location = New System.Drawing.Point(450, 1)
        ...
        Me.Label11.Location = New System.Drawing.Point(511, 30)
        ...
        Me.Label10.Location = New System.Drawing.Point(450, 30)
        ...
        Me.Label4.Location = New System.Drawing.Point(272, 30)
        ...
        Me.Label3.Location = New System.Drawing.Point(171, 30)
        ...
        Me.Label1.Size = New System.Drawing.Size(82, 58)
        ...
        Me.tlpPressionCroissant.ColumnCount = 7
        ...
        Me.tlpPressionCroissant.ColumnStyles.Add(New System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 108.0!))
        ...
        Me.tlpPressionDecroissante.ColumnCount = 7
        ...
        Me.tlpPressionDecroissante.ColumnStyles.Add(New System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 108.0!))
        ...
        Me.tlpRepetition.ColumnCount = 7
        ...
        Me.tlpRepetition.ColumnStyles.Add(New System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 108.0!))
...
#End Region
    ...
    Private Sub controle_manometres_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim arrManoEtalon As List(Of ManometreEtalon) = ManometreEtalonManager.getlstByAgent(m_oAgent, False)
        ...
        '####################################################
        Dim oParametrage As New lstParamMetrologie()
        If Not oParametrage.readXML() Then
            MsgBox("Le parametrage de la metrologie est incorrect, contactez le CRODIP")
            Exit Sub
        End If
        ...
        Dim arrManoControle As List(Of ManometreControle) = ManometreControleManager.getlstEnServiceByAgent(m_oAgent, True)
    ...
    Dim m_bAfficheAjusteur As Boolean = False
    ''' <summary>
    ...
    Private Sub AfficheControleMano(pControleMano As ControleMano)
        ...
        'Vérification si changement de paramétrage
        Dim bMAJIHM As Boolean = True
        If nUp = tlpPressionCroissant.RowStyles.Count And nDown = tlpPressionDecroissante.RowStyles.Count And nRepe = tlpRepetition.RowStyles.Count Then
            bMAJIHM = False
        End If
        'on force le réaffichage  s'il y a un changement d'ajusteur
        Dim oMano As ManometreControle = m_bsManoControle.Current
        If oMano.bAjusteur <> m_bAfficheAjusteur Then
            bMAJIHM = True
        End If
        m_bAfficheAjusteur = oMano.bAjusteur

        If bMAJIHM Then
            SurroundingClass.BeginControlUpdate(tlpGlobal)
        ...
        nLigne = 1
        For Each oLigneDetail As ControleManoDetail In lstCtrlManoDetail
            AfficheLgCtrlManoDetail(tlpPressionCroissant, oLigneDetail, nLigne, bMAJIHM)
            nLigne = nLigne + 1
        Next
        If bMAJIHM Then
        ...
        nLigne = 1
        For Each oLigneDetail As ControleManoDetail In lstCtrlManoDetail
            AfficheLgCtrlManoDetail(tlpPressionDecroissante, oLigneDetail, nLigne, bMAJIHM)
            nLigne = nLigne + 1
        Next
        If bMAJIHM Then
            If lstCtrlManoDetail.Count > 1 Then
        ...
        nLigne = 1
        For Each oLigneDetail As ControleManoDetail In lstCtrlManoDetail
            AfficheLgCtrlManoDetail(tlpRepetition, oLigneDetail, nLigne, bMAJIHM)
            nLigne = nLigne + 1
        Next
        If bMAJIHM Then
            If lstCtrlManoDetail.Count > 1 Then
        ...
        If bMAJIHM Then
            SurroundingClass.EndControlUpdate(tlpGlobal)
        End If
    ...
    Private Sub AfficheLgCtrlManoDetail(pTableLayoutPanel As TableLayoutPanel,
                                        ...
                                        pNumLigne As Integer, pbMAJIHM As Boolean)
        ...
        Else
            oLbl = pTableLayoutPanel.GetControlFromPosition(1, pNumLigne - 1)
        End If
        oLbl.Text = pLgCtrlManoDetail.point
        ...
        If pLgCtrlManoDetail.bAjusteur Then
            If pbMAJIHM Then
                ...
                oCtrl = oNup
            Else
                oCtrl = pTableLayoutPanel.GetControlFromPosition(2, pNumLigne - 1)
        ...
        If pbMAJIHM Then
            ...
            End If
        Else
            otb = pTableLayoutPanel.GetControlFromPosition(3, pNumLigne - 1)
            otb.DataBindings.Clear()
        End If
        ...
        Else
            otb = pTableLayoutPanel.GetControlFromPosition(4, pNumLigne - 1)
            otb.DataBindings.Clear()
        End If
        ...
        Else
            otb = pTableLayoutPanel.GetControlFromPosition(5, pNumLigne - 1)
            otb.DataBindings.Clear()
        End If
        ...
        Else
            otb = pTableLayoutPanel.GetControlFromPosition(6, pNumLigne - 1)
            otb.DataBindings.Clear()
        End If
            ...
            For Each curManoControle In m_bsManoControle
                ...
                If curManoControle.isUpdated Then
                    ...
                    If oCtrlMano IsNot Nothing Then
                        ...
                        ' On récupère le mano
                        Dim oManoE As ManometreEtalon = m_bsManoEtalon.Current
                        ' On le flag
                        CSDebug.dispInfo("frmControleManager.EnregistrerLesControles : Set ManoEtalon utilisé ")
                        ManometreEtalonManager.setUtilise(m_oAgent, oManoE)

                        Statusbar.display("Synchronisation Manomètre [" & curManoControle.numeroNational & "]")
                        curManoControle.SynchronisationASCManos(m_oAgent, oFV, oManoE)
                        Statusbar.display("")
                    End If
                End If
            Next
    ...
    Private Sub ValiderSaisie(pControle As ControleMano)
        If (isSaisieComplete()) Then
            ...
            If checkMano(pControle) Then
                lblResultat.Text = "Votre manomètre est fiable : il est conforme à sa classe d'exactitude."
                lblResultat.ForeColor = System.Drawing.Color.Green
            Else
                lblResultat.Text = "Votre manomètre n'est pas fiable : il n'est pas conforme à sa classe d'exactitude. Faites le remettre en état ou changez le."
