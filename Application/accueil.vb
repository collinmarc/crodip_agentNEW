...
#Region " Code généré par le Concepteur Windows Form "
    ...
    Public Sub New()
        ...
        'Et il faut parfois supprimer des cols du datagridview
        For n As Integer = dgv_ControleRegulier.Columns.GetColumnCount(DataGridViewElementStates.None) To 6 Step -1
            dgv_ControleRegulier.Columns.RemoveAt(n - 1)
        Next n
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.tabAccueil_mesinfos.Controls.Add(Me.lblPC)
        Me.tabAccueil_mesinfos.Controls.Add(Me.Label14)
        ...
        Me.Label14.Location = New System.Drawing.Point(360, 104)
        ...
        Me.Label13.Location = New System.Drawing.Point(360, 80)
        ...
        '
        Me.lbl_infosAgent_IdCrodip.Location = New System.Drawing.Point(168, 32)
        ...
        Me.lbl_infosAgent_IdCrodip.Text = "IdCrodip"
        '
        'pctLogo
        '
        ...
        Me.lbl_mesInfos_dateDerniereUtilisation.Location = New System.Drawing.Point(360, 32)
        ...
        Me.lbl_mesInfos_prenom.Location = New System.Drawing.Point(48, 80)
        ...
        Me.lbl_mesInfos_nom.Location = New System.Drawing.Point(48, 56)
        ...
        Me.lbl_mesInfos_idCrodip.Location = New System.Drawing.Point(48, 32)
        ...
        Me.title_mesInfos.Location = New System.Drawing.Point(16, 5)
        ...
        'lbl_infosAgent_Nom
        '
        Me.lbl_infosAgent_Nom.Location = New System.Drawing.Point(168, 56)
        ...
        Me.lbl_infosAgent_Nom.Text = "nomAgent"
        '
        'lbl_infosAgent_Prenom
        '
        Me.lbl_infosAgent_Prenom.Location = New System.Drawing.Point(168, 80)
        ...
        Me.lbl_infosAgent_Prenom.Text = "Prénom Agent"
        '
        ...
        Me.btnMAJPulveFromDiag.Text = "MAJ pulvé <- DIAG"
        ...
        Me.btnMAJPulverisateurs.Text = "MAJ des Etats de pulvés"
        ...
        Me.btn_parametrage_tarifs.Visible = Global.Crodip_agent.MySettings.Default.GestiondeTarifActif
        '
        ...
        Me.btn_parametrage_verificationManometres.Visible = Global.Crodip_agent.MySettings.Default.GestionMetrologieActif
        '
        ...
        Me.btn_parametrage_verificationBancs.Visible = Global.Crodip_agent.MySettings.Default.GestionMetrologieActif
        '
        ...
        Me.rbNumFact.Text = "Numéro de facture :"
...
#Region " *** Loaders *** "
    ...
    Private Sub accueil_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        End If
        If agentCourant.oPCcourant IsNot Nothing Then
            lblPC.Text = agentCourant.oPCcourant.libelle
        End If
...
#Region " Fonctions de chargement "
    ...
    Private Sub loadAccueilAlertsMAJ(ByRef positionTopAlertes As Integer)
        ...
        If nPulve > 0 Then
            AjouteUneAlerte(GlobalsCRODIP.ALERTE.NOIRE, "MAJ Pulvérisateurs", nPulve & " Pulverisateurs mis à jour, ils seront transférés au crodip lors de la prochaine synchronisation", positionTopAlertes)
        End If
...
#End If
    ...
    Private Sub btnMAJPulveFromDiag_Click(sender As Object, e As EventArgs) Handles btnMAJPulveFromDiag.Click
        ...
        If nPulvesMAJ >= 1 Then
            MsgBox(nPulvesMAJ & " pulverisateurs mis à jour, ils seront transférés au crodip lors de la prochaine synchronisation", MsgBoxStyle.OkOnly, "Mise à jour des pulvérisateurs depuis les contrôles")
        End If
        If nPulvesMAJ = 1 Then
            MsgBox(nPulvesMAJ & " pulverisateur mis à jour, il sera transféré au crodip lors de la prochaine synchronisation", MsgBoxStyle.OkOnly, "Mise à jour des pulvérisateurs depuis les contrôles")
        End If
        If nPulvesMAJ = 0 Then
            MsgBox("Aucun pulverisateur mis à jour, rien ne sera transféré au crodip lors de la prochaine synchronisation", MsgBoxStyle.OkOnly, "Mise à jour des pulvérisateurs depuis les contrôles")
        End If
        If nPulvesMAJ < 0 Then
            MsgBox("ATTENTION ERREUR LORS DE LA MISE A JOUR DES PULVERISATEURS, CONTACTEZ LE CRODIP", MsgBoxStyle.OkOnly, "Mise à jour des pulvérisateurs depuis les contrôles")
        End If
