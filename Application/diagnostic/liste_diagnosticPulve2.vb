...
Public Class liste_diagnosticPulve2
    ...
    Friend WithEvents Col_Enquete As DataGridViewImageColumn
...
#Region " Code généré par le Concepteur Windows Form "
    ...
    Private Sub InitializeComponent()
        ...
        Me.Col_Enquete = New System.Windows.Forms.DataGridViewImageColumn()
        ...
        'm_bsrcDiag
        '
        Me.m_bsrcDiag.DataSource = GetType(CRODIPWS.Diagnostic)
        '
        'btn_reprendreDiag
        '
        ...
        'Col_Enquete
        '
        Me.Col_Enquete.HeaderText = "Enquête"
        Me.Col_Enquete.Image = Global.Crodip_agent.Resources.PDF
        Me.Col_Enquete.Name = "Col_Enquete"
        Me.Col_Enquete.ReadOnly = True
        Me.Col_Enquete.Width = 53
        '
        'COPROColumn
        '
...
#End Region
    ...
    Sub searchDiagnostic(ByVal param As String)
        Try
            ...
            For Each oDiag As Diagnostic In m_bsrcDiag.List
                ...
                oCellI = DataGridView1.Rows(nRow).Cells(Col_Enquete.Index)
                oCellI.Style.BackColor = System.Drawing.Color.White
    ...
    Private Sub liste_diagnosticPulve_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Else
            Me.Text = "Crodip .::. Liste des contrôles"
        End If
        Col_Enquete.Visible = DiagMode <> GlobalsCRODIP.DiagMode.CTRL_CV
        col_contrat.Visible = DiagMode <> GlobalsCRODIP.DiagMode.CTRL_CV
        Col_Rapports.Visible = True
        col_SM.Visible = True
    ...
    Private Sub DataGridView1_CellMouseEnter(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellMouseEnter
        Try
            ...
            If m_oDiag IsNot Nothing Then
                Select Case e.ColumnIndex
                    Case Col_Rapports.Index, col_SM.Index, col_contrat.Index, FactureColumn.Index, BLColumn.Index, Col_Enquete.Index, COPROColumn.Index
