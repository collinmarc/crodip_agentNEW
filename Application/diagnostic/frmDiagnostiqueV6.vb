...
Imports System.IO
Public Class frmDiagnostiqueV6
    Inherits frmCRODIP
    ...
    Protected Const ROW_MANO As Integer = 3
...
#Region " Tests "
    ...
    Public Function pressionTroncons_checkIsAllFilled(ByVal pressionId As Integer) As Boolean
        ...
        Return True
    End Function
    Public Function pressionTroncons_checkIsAllFilledADEL() As Boolean
        'Return True
...
#Region " Calculs "
    ...
    Private Function mutCalcNbBuses(ByVal lotId As Integer) As Integer
        Try
...
#Region " Events "
    ...
    Private Function validNbCategories() As Boolean
...
#End Region
        ...
        Try
            ...
            If TB IsNot Nothing Then
                ...
                If IsNumeric(TB.Text) Then
                    ...
                    bReturn = True
                Else
                    Dim imprecisionTextBox As CRODIP_ControlLibrary.TBNumeric = Nothing
                    Dim ecartTextBox As New CRODIP_ControlLibrary.TBNumeric()
    ...
    Private Sub designdgv(ByVal pNbNiveaux As Integer, ByVal pNbTroncons As Integer, ByVal pNPression As Integer)
        Try
            ...
            pdgvPression(0, ROW_MANO).Value = "Manomètre"
            ...
            pdgvPression(0, ROW_MANO).Style = oHeaderStyle
            ...
            Dim oCell As New DataGridViewComboBoxCell()
            oCell.Items.Add("Mano1")
            oCell.Items.Add("Mano2")
            oCell.Items.Add("Mano3")
            pdgvPression(1, ROW_MANO) = oCell
            oCell = New DataGridViewComboBoxCell()
            oCell.Items.Add("Mano1")
            oCell.Items.Add("Mano2")
            oCell.Items.Add("Mano3")
            pdgvPression(2, ROW_MANO) = oCell
            oCell = New DataGridViewComboBoxCell()
            oCell.Items.Add("Mano1")
            oCell.Items.Add("Mano2")
            oCell.Items.Add("Mano3")
            pdgvPression(3, ROW_MANO) = oCell
