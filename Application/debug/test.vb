...
'        Try
'            objAgent = AgentManager.WSgetByNumeroNational("agent-1")
...
'            Dim response As Integer = AgentManager.WSSend(tmpAgent, UpdatedObject)
...
'        Try
'            objClient = ExploitationManager.WSgetById("1-1-1")
...
'        Try
'            Dim UpdatedObject As Object = Nothing
'            Dim response As Integer = ExploitationManager.WSSend(objClient, UpdatedObject)
'            'MsgBox("Code retour : " & response.ToString)
'            Select Case response
'                Case -1 ' ERREUR
...
'        Try
'            objStructure = StructureManager.WSgetById(1)
...
'        Dim objStructure As [Structure] = StructureManager.getStructureById("1")
'        'objStructure.id = "1"
...
'        Try
'            Dim UpdatedObject As Object = Nothing
'            Dim response As Integer = StructureManager.WSSend(objStructure, UpdatedObject)
'            Select Case response
'                Case -1 ' ERROR
'                    MsgBox("Erreur - sendWSStructure - Erreur Locale")
'                Case 0 ' OK
...
'        tmpStructure = StructureManager.getStructureById(1)
'        If tmpStructure.id <> 0 Then
'            MsgBox("Structure n°" & tmpStructure.id & " (" & tmpStructure.nom & ") Chargée.")
'        Else
...
'        Try
'            objDiagnostic = DiagnosticManager.WSgetById("1-1-1")
...
'            Dim UpdatedObject As Object = Nothing
'            Dim response As Integer = DiagnosticManager.WSSend(tmpDiagnostic, UpdatedObject)
...
'        Try
'            objPulverisateur = PulverisateurManager.WSgetById("1-1-1")
...
'        Try
'            Dim UpdatedObject As Object = Nothing
'            Dim response As Integer = PulverisateurManager.WSSend(objPulverisateur, UpdatedObject)
'            Select Case response
'                Case -1 ' ERROR
