...
Public Class cr_EtatSynthese
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent.cr_EtatSynthese.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_EtatSynthese
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_EtatSynthese = New cr_EtatSynthese()
        rpt.Site = Me.Site
        Return rpt
    End Function
