...
Public Class cr_facture_dev
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_facture_dev.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_facture_dev
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_facture_dev = New cr_facture_dev()
        rpt.Site = Me.Site
        Return rpt
    End Function
