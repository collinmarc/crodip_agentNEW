...
Public Class cr_synthese833
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_synthese833.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_synthese833
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_synthese833 = New cr_synthese833()
        rpt.Site = Me.Site
        Return rpt
    End Function
