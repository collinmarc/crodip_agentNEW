...
Public Class cr_DocCopropiete
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_DocCopropiete.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_DocCopropiete
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_DocCopropiete = New cr_DocCopropiete()
        rpt.Site = Me.Site
        Return rpt
    End Function
