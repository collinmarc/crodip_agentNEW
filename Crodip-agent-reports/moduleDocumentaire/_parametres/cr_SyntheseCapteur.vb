...
Public Class cr_SyntheseCapteur
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_SyntheseCapteur.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_SyntheseCapteur
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_SyntheseCapteur = New cr_SyntheseCapteur()
        rpt.Site = Me.Site
        Return rpt
    End Function
