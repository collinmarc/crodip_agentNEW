...
Public Class cr_syntheseBuses5
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_syntheseBuses5.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_syntheseBuses5
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_syntheseBuses5 = New cr_syntheseBuses5()
        rpt.Site = Me.Site
        Return rpt
    End Function
