...
Public Class cr_Synthese12123
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_Synthese12123.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_Synthese12123
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_Synthese12123 = New cr_Synthese12123()
        rpt.Site = Me.Site
        Return rpt
    End Function
