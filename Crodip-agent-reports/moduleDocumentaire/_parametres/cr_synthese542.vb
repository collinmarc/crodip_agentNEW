...
Public Class cr_synthese542
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_synthese542.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_synthese542
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_synthese542 = New cr_synthese542()
        rpt.Site = Me.Site
        Return rpt
    End Function
