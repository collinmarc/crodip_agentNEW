...
Public Class cr_ReglagePulvesynthese833
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "cr_ReglagePulvesynthese833.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Crodip_agent_reports.cr_ReglagePulvesynthese833.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcr_ReglagePulvesynthese833
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cr_ReglagePulvesynthese833 = New cr_ReglagePulvesynthese833()
        rpt.Site = Me.Site
        Return rpt
    End Function
